        ...
        <div class="page-body">
            ...
            <div class="fans-center">
                <ul class="center-list">
                    <li class="list-item" style="color: rgb(56, 55, 55);font-size: 0.9em;">全部粉丝(<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>)</li>
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    <ItemTemplate>
                        <div class="fans-list">
                            ...
                            <asp:LinkButton ID="LinkButton1" CommandArgument='<%#Eval("id") %>' OnCommand="LinkButton1_Command" runat="server"> <input type="button" value="回粉" class="btn_hf"></asp:LinkButton>
                            <asp:LinkButton ID="LinkButton2" CommandArgument='<%#Eval("id") %>' OnCommand="LinkButton2_Command" runat="server"><input type="button" value="移除粉丝" class="btn_yc"></asp:LinkButton>
